...
router.register(r'lineMessageGroups', notifications_api.LineMessageGroupViewSet)
...
urlpatterns = patterns('',
    ...
    url(r'^report/protect-submit/(?P<key>[.\w-]+)/(?P<domain_id>\d*)/', 'reports.api.report_protect_submit', name='report_protect_submit'),
    ...
    url(r'^my-reports/$', 'reports.api.my_reports', name='my_reports'),
    url(r'^my-reports/(?P<report_id>\d+)/', 'reports.api.my_report_detail', name='my_report_detail'),
    ...
    url(r'^animals/map/', 'animal.views.list_animal_record_for_map', name='list_animal_record_for_map'),
