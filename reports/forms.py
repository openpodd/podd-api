...
class ReportTypeForm(forms.ModelForm):
    ...
    class Meta:
        model = ReportType
        fields = ('name', 'code', 'category', 'authority', 'user_status', 'form_definition', 'file', 'template', 'django_template', 'summary_template', 'weight', 'followable', 'is_system', 'follow_days', 'version')
